    ...
    void setReport(LocalDate dateFrom, LocalDate dateTo) throws SQLException, IOException, ClassNotFoundException {
		...
		if(rs.next()) {
			...
			do {
				...
				lblBillTotal.setPrefWidth(80);
				lblBillTotal.setStyle("-fx-font-size: 10; -fx-padding:0 0 0 0;");
				...
				newItem.getChildren().addAll(lblBillNumber, lblBillTotal, 
						lblClientBalance, lblClientDebit, lblTime);
