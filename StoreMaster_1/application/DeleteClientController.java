...
public class DeleteClientController {
	...
	@FXML
    void deleteClient(MouseEvent event) throws IOException, ClassNotFoundException, SQLException {
		Connection conn = null;
		try {
			conn=DBinfo.connDB();
			
			String strUpdate ="DELETE FROM `clients` WHERE `name` =?";  
		...
		label2.setText("Client Deleted Successfully");
