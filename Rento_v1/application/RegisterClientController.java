...
public class RegisterClientController {
    ...
    String licenseImagePath = "file:/D:/Rento/photos/noimage.jpg";
    String idImagePath = "file:/D:/Rento/photos/noimage.jpg";
    ...
    private void cleareFields() {
    	...
    	licenseImagePath = "file:/D:/Rento/photos/noimage.jpg";
        idImagePath = "file:/D:/Rento/photos/noimage.jpg";
    }
    
    @FXML
    void cancelRegisterClient(MouseEvent event) throws IOException {
    	cleareFields();
    }

	@FXML
    void confirmRegisterClient(MouseEvent event) throws IOException, ClassNotFoundException, SQLException {    	
    	//validate user data
    	...
    	//Create images in photos folder
    	Date date = new Date();
    	
    	//*****************************************//
    	int lastSlash = licenseImagePath.lastIndexOf("/");
    	String imageName = licenseImagePath.substring(lastSlash+1);
    	
    	Image image = new Image(licenseImagePath);
        ...
        licenseImagePath = "file:/D:/Rento/photos/"+date.getTime()+"_"+imageName;
    	
      //*****************************************//
        
      //*****************************************//
    	int lastSlash2 = idImagePath.lastIndexOf("/");
    	String imageName2 = idImagePath.substring(lastSlash2+1);
    	
    	Image image2 = new Image(idImagePath);
    	    	
    	File outputFile2 = new File("D:\\Rento\\photos\\"+date.getTime()+"_"+imageName2);
        BufferedImage bImage2 = SwingFXUtils.fromFXImage(image2, null);
        try {
          ImageIO.write(bImage2, "jpg", outputFile2);
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
        
        idImagePath = "file:/D:/Rento/photos/"+date.getTime()+"_"+imageName2;
      ...
      //*****************************************//
    	...
    	try {
			...
			ps.setString(6, idImagePath);
			ps.setString(7, licenseImagePath);
		...
		File selectedFile = fileChooser.showOpenDialog(stage);
		 ...
		 if(selectedFile != null) {
			 ...
			 if(strEventSource.contains("btnIdImage")) {
				 ...
				 idImagePath = new File(path).toURI().toString();
			 }else {
				 licenseImage.setImage(image);
				 licenseImagePath = new File(path).toURI().toString();
			 }
		 }
    }
}
