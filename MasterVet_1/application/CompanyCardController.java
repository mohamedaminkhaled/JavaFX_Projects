...
public class CompanyCardController {
    ...
    @FXML
    void getCompanyMedicines(MouseEvent event) throws IOException, ClassNotFoundException, SQLException {
    ...
    void setCompanyCard(String name) throws SQLException, ClassNotFoundException {
